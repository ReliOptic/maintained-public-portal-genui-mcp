...
export const demoAdapterDiscovery: AdapterDiscoveryResponse = {
  ...
  adapters: [
    ...
    },
    {
      ...
      statusReason: "Live EV availability requires a server-side key boundary."
    },
    {
      ...
      statusReason: "ADR-0022 role decision required before legal lookup or legal text handling.",
